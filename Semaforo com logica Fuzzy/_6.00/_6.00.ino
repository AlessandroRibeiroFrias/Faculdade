...
void fuzzy_primario(){
  ...
  ler_sensores();
  if ((iniciaSensor0 > 200 && iniciaSensor1 > 200) && (iniciaSensor2 == 1 && iniciaSensor3 == 1) && (tempo2 < 20))
{
    while((iniciaSensor0 > 200 && iniciaSensor1 > 200) && (iniciaSensor2 == 1 || iniciaSensor3 == 1) && (tempo2 < 20)){
  ...
  if ((SemaforoVerdeBrasil == 1) && (iniciaSensor0 < 200 || iniciaSensor1 < 200)){
      while((iniciaSensor0 < 200 || iniciaSensor1 < 200) && (iniciaSensor2 == 1 && iniciaSensor3 == 1) && (tempoBrasil < 20)){
  ...
  if ((SemaforoVerdeHerval == 1) && (iniciaSensor2 == 0 || iniciaSensor3 == 0)){
      while((iniciaSensor0 > 200 && iniciaSensor1 > 200) && (iniciaSensor2 == 0 || iniciaSensor3 == 0) && (tempoHerval < 20)){
